...
|---|---|---|
|**Arcane Focus**|A finely crafted magical instrument used for spellcasting. Grants +1 to spell attack rolls and saving throw DCs. _(Only works for 1 week; 10x for permanent)_|50 gp / 500 gp|
|**Astral Map**|A magical map that shows the position of celestial bodies and magical ley lines.|400 gp|
|**Elixir of Knowledge**|A drink that grants the user the ability to learn a new spell instantly (up to level 3). _(Wizards only, and only 1 per month or else...)_|300 gp|
|**Gem of Fire**|A gem that can store a single fire-based spell for later use. _(3 uses)_|250 gp|
|**Potion of Mana**|A drink that restores a spellcaster’s spell slots. _(1 level 3 spell slot or 3 level 1 slots)_|100 gp|
...
|**Spellbook of the Stars**|A rare spellbook containing ancient spells, including ???.|2500 gp|
|**Tome of the Ancients**|A mysterious book containing long-forgotten spells of powerful wizards.|50,000 gp|
|**Wand of Arcane Blast**|A wand that allows the user to cast _Magic Missile_ three times per day.|200 gp|
|**Wandcap**|When placed on a wand, it changes the damage type of spells used through it to the cap’s type.|100 gp|
|**Ring of the Scholar**|Grants advantage on Arcana checks and allows the wearer to transcribe spells at half the usual cost.|600 gp|
|**Bracers of Focus**|Reduces the required components of spells costing less than 50 gp.|1,200 gp|
|**Gloves of Somatic Mastery**|Allows a spellcaster to ignore the somatic component of one spell per short rest.|500 gp|
|**Lantern of Revealing**|Reveals invisible creatures and objects within 30 feet when lit.|800 gp|
|**Rod of Spell Storing**|Stores up to 3 levels of spells that can be cast later.|2,000 gp|
|**Scroll of Counterspell**|Contains the _Counterspell_ spell.|300 gp|
|**Crystal of Minor Amplification**|Slightly increases spell range and potency. _(+10 feet to range and +1 to spell attack rolls, lasts for 24 hours when activated)_|150 gp|
|**Mystic Ink (1 vial)**|Used to scribe magic scrolls and inscribe spells in a spellbook. _(Scribing spells costs half as much when using this ink)_|75 gp|
|**Resonant Chime**|When rung, creates a temporary anti-magic field in a 5-foot radius for 1 minute. _(3 uses, recharges at dawn)_|1,500 gp|

---

### **Magic Tower Services**

| Service                         | Description                                                                                     | Price (gp)        |
| ------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------- |
| **Spell Scribing**              | Scribes a spell scroll (level 1-3) for a spellcaster. _(Materials must be provided separately)_ | 100-500 gp        |
| **Enchanting Basic Items**      | Adds minor magical properties to mundane objects (e.g., self-warming cloak, ever-lit lantern).  | 200-1,000 gp      |
| **Custom Wand Crafting**        | Creates a wand that casts a specified spell (level 1-3, 3 uses per day).                        | 800-2,500 gp      |
| **Identify Service**            | Identifies the properties of a magical item.                                                    | 10 gp             |
| **Spell Copying (for Wizards)** | Transfers a spell from one book to another (materials must be provided).                        | 50 gp + materials |
| **Magical Consultation**        | Provides expert advice on magic, enchantments, and arcane anomalies.                            | 25 gp per hour    |
| **Temporary Enchantments**      | Grants a non-magical item a temporary +1 enchantment for 24 hours. _(Weapons, armor, or tools)_ | 300 gp            |
