...
|**Cloak of Protection**|125 CP|Grants **+1 to AC and saving throws**.|
|**Immovable Rod**|150 CP|Stays **fixed in place** until deactivated.|
|**Goggles of Night**|80 CP|Grants **darkvision out to 60 feet**.|
|**Ring of Water Walking**|100 CP|Allows the wearer to **move across water as if it were solid ground**.|
...
|**Rune-Engraved Armor**|500 CP|Armor that grants **+1 to AC** and has a magical rune effect.|
