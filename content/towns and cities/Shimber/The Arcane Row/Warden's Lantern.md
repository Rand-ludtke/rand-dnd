...
|**Fate Spinner**|A small device that can **alter the outcome of a single roll**.|1,000 gp|
|**Dreamcatcher**|Allows the user to **see glimpses of the future in dreams**.|350 gp|
|**Diviner's Wand**|Enhances **divination spells**, granting **+1 to spellcasting ability**.|600 gp|
...
|**Spirit Focus**|Enhances **summoning spells**, granting **+1 to spellcasting ability**.|750 gp|
|**Lantern of Prophecy**|Reveals **hidden truths in the dark**, granting **+1 to Investigation checks**.|300 gp|
|**Timepiece of Foresight**|Allows the user to **glimpse the immediate future** (1 use).|500 gp|
|**Astral Compass**|A compass that **points to the nearest astral portal**.|400 gp|
|**Ethereal Lens**|A lens that **reveals invisible creatures** within 30 ft.|250 gp|
|**Divination Crystal**|A crystal that **enhances divination spells**, granting **+1 to spell attack rolls**.|300 gp|
|**Oracle's Quill**|A quill that **writes prophetic messages** when used.|150 gp|
|**Fateweaver's Thread**|A thread that can **alter the outcome of a single event** (1 use).|1,000 gp|
...
|---|---|---|
|**Divination Consultation**|**Expert advice** on divination and scrying techniques.|50 gp/hour|
|**Scrying Session**|Use the shop’s **crystal ball or scrying mirror** to locate a target.|100 gp|
|**Custom Divination Tool**|Collaborate with the shop to **create a custom divination tool**.|500 gp|
|**Divination Tool Repair**|**Repair damaged divination tools** to restore functionality.|25 gp|
